...
const UploadCard = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Set a timeout for slow backend
      ...
      setError("Prediction failed. Try again or check the backend.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      {loading && <p className="text-blue-600 text-center mt-4">Analyzing image, please wait...</p>}
